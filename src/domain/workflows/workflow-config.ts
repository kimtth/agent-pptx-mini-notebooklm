...
export const WORKFLOW_CONFIGS: Record<WorkflowId, WorkflowConfig> = {
  ...
  'create-pptx': {
    ...
    agentDirective: 'Use this workflow for final PPTX creation only. Output the final python-pptx code block. If layout validation fails, repair the layout specs or validator thresholds and rerun the render.',
    triggerPrompt: 'Run the create PPTX workflow now. Use the approved slides, theme, icons, colors, and attached images. Generate the final python-pptx code block. If layout validation fails, repair the layout specs or validator thresholds and rerun the render.',
  },
  poststaging: {
    id: 'poststaging',
    ...
    steps: [
      ...
      'If blocking issues exist (missing images/icons, ERROR-level overlap/overflow), output corrective code or repair the layout infrastructure and rerun the render.',
